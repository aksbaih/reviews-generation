...
if not os.path.exists("../../dataset/classify_checkpoint"): os.mkdir("../../dataset/classify_checkpoint")
formatted_dataset[:ctrain].to_csv("../../dataset/classify_checkpoint/train.csv")
formatted_dataset[ctrain:ctrain+cval].to_csv("../../dataset/classify_checkpoint/val.csv")
formatted_dataset[-ctest:].to_csv("../../dataset/classify_checkpoint/test.csv")
print(f"The data is split into Train: {ctrain}, Val: {cval}, Test: {ctest} " 
      f"\n And saved in the ../../dataset/classify_checkpoint directory.")

# Now, finetune GPT2 on this dataset
# Set --nproc_per_node to the number of gpus
train_path = os.path.abspath("../../dataset/classify_checkpoint/train.csv")
