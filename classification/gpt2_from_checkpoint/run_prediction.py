...
# coding=utf-8
"""
I adopted this code from the huggingface transformers repo https://github.com/huggingface/transformers
and modified it such that it supports text-generation for many prompts sequentially
"""
...
def main():
    ...
    try:
        ...
        prompts = [row[:row.find("<pred>")+len("<pred>")] for row in df_texts]
    except:
    ...
    for prompt_text in (tqdm(prompts, file=sys.stdout) if args.quite else prompts):
        ...
        for generated_sequence_idx, generated_sequence in enumerate(output_sequences):
            ...
            total_sequence = total_sequence[total_sequence.find("<pred>") + len("<pred>"):][:4]
